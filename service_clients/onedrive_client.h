...
#ifndef CLOUD_STORAGE_ONEDRIVE_CLIENT_H
#define CLOUD_STORAGE_ONEDRIVE_CLIENT_H
...
class OneDriveClient: public ServiceClient {
public:
    OneDriveClient();
    ~OneDriveClient();
...
#endif //CLOUD_STORAGE_ONEDRIVE_CLIENT_H
